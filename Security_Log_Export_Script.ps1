# Original Powershell Script from Jash Madakor: https://github.com/joshmadakor1
# Sign up and get your API key from here: https://ipgeolocation.io/
# There is a 1000 Daily request limit on the DEVELOPER FREE TIER.
